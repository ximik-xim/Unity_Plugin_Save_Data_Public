...
[CreateAssetMenu(menuName = "Save Data/Storage Data/Storage/String/Server")]
public class SD_StorageDataStringServer :  SD_AbsStringStorage, IInitScripObj
{
   ...
   public void InitScripObj()
    ...
    {
        return JsonUtility.ToJson(_saveDataStringDefListData);
    }
    ...
    public override string GetData(SD_KeyStorageStringVariable dataKey)
    {
        ...
        return _saveDataStringDefListData.GetValue(dataKey.GetKey());
    }
